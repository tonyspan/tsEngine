...
namespace tsEngine
{
	...
	bool PhysicsManager::CheckForCollision(const Ref<EntityManager>& entityManager, const entt::entity entity1, const entt::entity entity2)
	{
	...
	bool PhysicsManager::CheckForAABoxAndCircle(const Ref<EntityManager>& entityManager, const entt::entity aabox, const entt::entity circle)
	{
